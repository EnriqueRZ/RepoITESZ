...
<form name="miFormulario" action="{{ route('updateMateria', $materia->id) }}" method="POST" autocomplete="on">
	@csrf
	<fieldset>
		<legend class="uno">
...
<div class="container" >
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Editar materia') }}</div>
						...
						<div class="col-md-6">
							<select id="id_carrera" type="text" class="browser-default custom-select form-control" name="id_carrera">
								@foreach($carreras as $carrera)
									@if ($carrera->nombre == $materia->cname)
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<input id="nombre" type="text" value="{{ $materia->nombre }}" class="form-control" name="nombre" required>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<input id="semestre" type="number" value="{{ $materia->semestre }}" max="9" min="1" class="form-control" name="semestre" required>
						</div>
					</div>		
