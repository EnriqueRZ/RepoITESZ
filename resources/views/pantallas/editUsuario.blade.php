                    ...
                    <div class="card-body">
                        <form  method="POST" action="{{ route('updateUsuario', $usuario->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="nombre" value="{{ $usuario->nombre }}" type="text" class="form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }}" name="nombre" value="{{ old('nombre') }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="id" value="{{ $usuario->id }}" type="number" class="form-control{{ $errors->has('id') ? ' is-invalid' : '' }}" name="id" value="{{ old('id') }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" value="{{ $usuario->email }}" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required>
                                ...
                                <div class="col-md-6">
                                    <select id="id_carrera" type="text" class="browser-default custom-select" name="id_carrera">
                                        @foreach($carreras as $carrera)
                                            @if($carrera->nombre == $usuario->cname) 
                                ...
                                <div class="col-md-6">
                                    <select id="id_tipo" type="number" class="browser-default custom-select form-control" name="id_tipo">
                                        @foreach($tipo_usuarios as $tipo_usuario)
                                            @if($tipo_usuario->id == $usuario->uid) 
                                                <option selected value="{{ $tipo_usuario->id }}">{{ $tipo_usuario->nombre_tipo_usuario }}</option>
                                            @else
